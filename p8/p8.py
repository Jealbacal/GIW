...
class Producto(Document):
    ...
    categoria_secundaria = ListField(IntField(), required=False)#opcional
    ...
    def clean(self):
        ...
        if not self.categoria_secundaria and self.categoria_secundaria[0] != self.categoria_principal:
...
class Usuario(Document):
        ...
        tarjetas = ListField(ReferenceField(Tarjeta),required=False,reverse_delete_rule="CASCADE")#opcional
        pedidos= ListField(ReferenceField(Pedido),required=False,reverse_delete_rule="CASCADE")
