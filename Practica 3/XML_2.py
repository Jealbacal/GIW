...
def subcategorias(filename):
    ...
    class Ejercicio2Handler(xml.sax.ContentHandler):
        ...
        def startElement(self, name, attrs):
            ...
            if name == "item":
                if attrs["name"] == "idCategoria" and attrs["name"] == "idSubcategoria":
                    self.curr_path.pop()
        ...
        def characters(self, content):
            ...
            if len(self.curr_path) >= 3 and self.curr_path[-4:] == ["categoria","subcategorias","subcategoria","item"]:
...
print(subcategorias("restaurantes_v1_es_pretty.xml"))
